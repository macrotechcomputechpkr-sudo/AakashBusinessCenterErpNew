    ...
    <div className="bg-[#0078d4] text-white flex items-center h-10 px-3 gap-3 flex-shrink-0">
      ...
      <div ref={navRef} className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            onClick={() => { setCompanyMenuOpen(!companyMenuOpen); setOpenMenu(null); }}
        ...
        <div className="relative">
          <button
            onClick={() => { setBranchMenuOpen(!branchMenuOpen); setOpenMenu(null); }}
            className="flex items-center gap-2 px-2 py-1 text-xs bg-white/10 hover:bg-white/20 transition-colors"
          >
        ...
        <div className="flex items-center gap-0.5 h-full">
          {[
            ...
            <div key={menu.label} className="relative h-full flex items-center">
              <button onClick={() => { setOpenMenu(openMenu === menu.label ? null : menu.label); setCompanyMenuOpen(false); setBranchMenuOpen(false); }} className="top-menu-button">
                {menu.label}
              </button>
              {openMenu === menu.label && (
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <div className="relative">
          <button
            onClick={() => { setShortcutOpen(!shortcutOpen); setOpenMenu(null); }}
